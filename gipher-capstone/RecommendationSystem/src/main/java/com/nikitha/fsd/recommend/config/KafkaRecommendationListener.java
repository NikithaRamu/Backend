...
public class KafkaRecommendationListener {
	...
	List<GifModelToSave>gifList = new ArrayList<GifModelToSave>();
     ...
     else
     {
    	 ...
    	 GifModelToSave gifToSave = new GifModelToSave();
    	 gifToSave.setGifId(gif.getGifId());
    	 gifToSave.setNumberOfTimeBookmarked(1);
    	 gifToSave.setGifURL(gif.getGifURL());
    	 gifRecommendService.saveGif(gifToSave);
     }
