...
//	private ProducerFactory<String, Gif> producerFactory=null;
//    private KafkaTemplate<String, Gif> kafkaTemplate = null;
...
//		ProducerRecord<String, Gif> record = new ProducerRecord<String, Gif>("topic",gif);
