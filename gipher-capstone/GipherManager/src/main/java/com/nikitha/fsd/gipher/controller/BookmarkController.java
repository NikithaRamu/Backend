...
public class BookmarkController {
	...
	@Autowired
	KafkaTemplate<String, Gif> kafkaTemplate;
	...
	{	
    	...
    	if(isGifAdded)
    	{
    		...
    		kafkaTemplate.send("test_topic",gif);
    	}
    	else
    	{
	...
	{	
    	...
    	{
    		gifListForUser.get().sort(Comparator.comparing(Gif::getBookmarkCreatedAt).reversed());
	...
	@GetMapping("/api/v1/bookmark/hello")
	public String testContoller() 
	{	
		return "hello user auth service";
	}
